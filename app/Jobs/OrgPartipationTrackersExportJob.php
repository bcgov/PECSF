...
class OrgPartipationTrackersExportJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle()
    {
        ...
        Excel::store(new OrgPartipationTrackersExport($this->history_id, $this->filters), 'public/'.$this->filename);  
    ...
    {
        echo "The job (PledgesExportJob) with process history id " . $this->history_id . " started at " . now() . PHP_EOL;
