...
class DonationDataReportExportJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle()
    {
        ...
        Excel::store(new DonationDataReportExport($this->history_id, $this->filters), 'public/'.$this->filename);  
    ...
    {
        echo "The job (DonationDataReportExportJob) process with history id " . $this->history_id . " started at " . now() . PHP_EOL;
