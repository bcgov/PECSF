...
class VolunteerProfilesExportJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle()
    {
        ...
        Excel::store(new VolunteerProfilesExport($this->history_id, $this->filters), 'public/'.$this->filename);  
    ...
    {
        echo "The job (VolunteerProfilesJob) with process history id " . $this->history_id . " started at " . now() . PHP_EOL;
