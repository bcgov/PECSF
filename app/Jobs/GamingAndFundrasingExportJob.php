...
class GamingAndFundrasingExportJob implements ShouldQueue, ShouldBeUnique
{
    ...
    public function handle()
    {
        ...
        Excel::store(new GamingAndFundrasingExport($this->history_id, $this->filters), 'public/'.$this->filename);  
    ...
    {
        echo "The job (GamingAndFundrasingExportJob) process with history id " . $this->history_id . " started at " . now() . PHP_EOL;
