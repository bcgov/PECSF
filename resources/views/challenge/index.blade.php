...
<table class="table table-bordered rounded" id="myTable2">
    ...
    <tr class="bg-light">
        ...
        <th onclick="sortTable('previous_participation_rate')" style="cursor: pointer;">Previous participation rate <img style="width:16px;height:16px;" class="sort-hook float-right" src="@php echo  ($request->sort == "ASC") ? asset("img/icons/FilterDescending.png"):asset("img/icons/FilterAscending.png") @endphp" /></th>
