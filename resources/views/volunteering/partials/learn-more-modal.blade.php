        ...
        <div class="modal-content">
            ...
            <div id="donateGuideCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                        ...
                        <div class="row">
                            <div class="col offset-sm-1">
                                ...
                                <ul class="check-bullet">
                                    <li><x-bullet />Put public service values into action</li>
                                    <li><x-bullet />Make a difference in your community</li>
                                    <li><x-bullet />Challenge yourself</li>
                                    <li><x-bullet />Develop your skills</li>
                                    <li><x-bullet />Show that you can be a leader</li>
                                    <li><x-bullet />Network with others across the provincial government</li>
                                    <li><x-bullet />Offer you skills - there are so many ways to contribute!</li>
                                </ul>
                            </div>
                            <div class="col-4">
                ...
                <div class="modal-footer d-flex">
                    ...
                    <x-button :href="route('donate')" role="button" class="ready-btn d-none">I'm ready to Volunteer!</x-button>
                </div>
            </div>
        </div>
    </div>
