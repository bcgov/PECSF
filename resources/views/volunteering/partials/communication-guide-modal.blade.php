<!-- Modal -->
<div class="modal fade" id="communication-guide-modal" tabindex="-1" aria-labelledby="communicationGuideModalTitle" data-backdrop="static"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" aria-label="Welcome to Volunteering!">Communications/Resources</h5>
                ...
                <div id="communicationGuideCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <h3 class="text-primary my-3 text-center">
                                What are some of the valuable PECSF Communications? 
                            </h3>
                        ...
                        <div class="carousel-item ">
                            ...
                            <div class="row pt-4     justify-content-center">
                                <div class="col-12">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-11">
                                            <h4 class="font-weight-bold">PECSF Community Connect SharePoint</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row pt-5 justify-content-center">
                                <div class="col-10">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-1 text-center text-primary">
                                            <span><i class="fas fa-gift  fa-2x"></i></span>
                                        </div>
                                        <div class="col-11">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-1 text-center text-primary">
                                            <span><i class="fas fa-calendar-alt  fa-2x"></i></span>
                                        </div>
                                        <div class="col-11">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-1 text-center text-primary">
                                            <span><i class="fas fa-user-tie  fa-2x"></i></span> 
                                        </div>
                                        <div class="col-11">  
            ...
            {{-- <div class="modal-footer d-flex">
                <x-button href="#communicationGuideCarousel" style="outline-primary" class="prev-btn d-none" role="button" data-slide="prev">Back</x-button>
...
<style>
	#communication-guide-modal a {
        text-decoration: underline;
	}

    #communication-guide-modal a:hover {
        font-weight: bold;
    }
...
<script>
    ...
    $(function () {
        ...
        var communication_total = 4;
        $('#communication-guide-modal').on('slide.bs.carousel', function (e) {
