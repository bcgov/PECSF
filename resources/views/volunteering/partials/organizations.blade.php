...
<table id="charities" class="col-md-12">
    @foreach($organizations as $key => $organization)
        ...
        <tr>
            <td style="width:60%;"><b>{{$organization->charity_name}}</b><br>{{$organization::CATEGORY_LIST[(!empty($organization->category_code) && in_array($organization::CATEGORY_LIST,$organization->category_code))]}} | {{$organization->city}} | {{$organization->province}} | {{$organization->country}}</td>
