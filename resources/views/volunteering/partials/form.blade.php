    ...
    width: 100%;" class="form-check-label pl-3" for="xxxpool{{ $pool->id }}">
        ...
        @include('donate.partials.choose-charity')
            ...
            <div class="form-row form-body">
                ...
                <div class="col-md-12"> <span style="display:block;padding:10px;">Browse to attach your completed PECSF Event Bank Deposit Form attachment (pdf,xls,xlsx,csv,png,jpg,jpeg) with bank receipt.</span>
                    </div>
