...
class MenuButtonLinks {
    ...
    constructor(domNode) {
        ...
        if ($(domNode).hasClass('has-treeview')) {
            this.buttonNode = domNode.querySelector('a.nav-link');
        } else {                    
    ...
    openPopup() {
        this.domNode.classList.add('menu-open');
    ...
    closePopup() {
        if (this.isOpen()) {
            this.domNode.classList.remove('menu-open');
