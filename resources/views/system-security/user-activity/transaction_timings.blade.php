...
<script>
    ...
    $(function() {
        ...
        myChart.on('legendselectchanged', function (params) {
            ...
            update_key_metrics(params.name);

            // update_chart();

        });

        function update_key_metrics(action_type) {
            ...
            $.ajax({
                url: '{!! route("system.transaction-timings") !!}',
                method: 'GET',
                data: formData,
                success: function(response) {
                    ...
                    $('#visit_min').html(data.visit_min);
                    $('#visit_avg').html(data.visit_avg);
                    $('#visit_max').html(data.visit_max);
