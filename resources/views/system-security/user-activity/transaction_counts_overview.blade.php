        ...
        <div class="row text-center px-5">
            ...
            <div class="col-5 ">
                ...
                <div class="form-inline">
                    ...
                    <select id="table-name" name='table-name' class="form-control">
        ...
        <div class="row text-center px-5">
            ...
            <div class="col-md-4">
                <div class="bg-warning text-white p-3 rounded">
                    <h2 class="h5">Average Transactions</h2>
    ...
    $(function() {
        ...
        function update_key_metrics() {
            ...
            var formData = {
                ...
                table_name : $("select[name='table-name']").val(),
            ...
            $.ajax({
                url: '{!! route("system.transaction-counts-overview") !!}',
                method: 'GET',
                data: formData,
