...
@section('content_header')
    ...
    <h4 class="mx-1 mt-3">Volunteer Profiles</h4>
...
@push('js')
    ...
    $(function() {
        ...
        var oTable = $('#history-table').DataTable({
            ...
            ajax: {
                url: '{!! route('reporting.volunteer-profiles.index') !!}',
                data: function (data) {
    	...
    	$(document).on("click", ".more-link , .show-process" , function(e) {
            ...
            $.ajax({
                method: "GET",
                url:  '{!! route('reporting.volunteer-profiles.index') !!}/' + id,
                dataType: 'json',
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        method: "GET",
                        dataType: 'json',
                        url: '{!! route('reporting.volunteer-profiles.export2csv') !!}',
        ...
        function exportProgress() {
            ...
            $.ajax({
                method: "GET",
                dataType: 'json',
                url:  '/reporting/volunteer-profiles/export-progress/' + batch_id,
                success: function(data)
                {
                    if (data.finished) {
