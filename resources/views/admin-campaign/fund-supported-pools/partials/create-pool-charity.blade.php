...
{{--
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
           ...
           <span class="descriptions_errors">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-5">
           ...
           <span class="contact_names_errors">
        ...
        <div class="form-group col-md-5">
           ...
           <span class="contact_titles_errors">
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
           ...
           <span class="contact_emails_errors">
