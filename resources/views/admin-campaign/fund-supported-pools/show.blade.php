...
<div class="card">
    {{-- <div class="card-header bg-light">
        <span class="text-dark font-weight-bold">Fund Supported Pool</span>
    </div> --}}
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="region" class="form-control" 
                            id="region" value="{{ $pool->region->name }}" disabled>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-2">
                    ...
                    <select name="pool_status" class="form-control" disabled>
                        <option value="A" {{ $pool->status == 'A' ? 'selected' : '' }}>Active</option>
                        <option value="I" {{ $pool->status == 'I' ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>
            </div>
