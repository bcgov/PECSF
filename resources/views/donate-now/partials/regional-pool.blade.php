...
<h3 class="mt-1">
    @if(str_contains(Route::current()->getName(), 'donate-now'))
        <h3>2. Choose your Regional Charity Programs pool</h3>
    @else
...
<div>
    ...
    <div class="card p-0 pl-2 bg-primary">
        <div class="card-body bg-light">
          ...
          Regional Charity Programs pool. Click <i class="fas fa-info-circle fa-lg"></i> to learn about the programs in each regional pool.
