<div id="step-summary-area">
                ...
                <div class="card bg-light p-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="float-right mb-2">${{ number_format($annualBiWeeklyAmount / 26,2) }}</span><br>
    ...
    <div class="row">
            ...
            <div>
                ...
                <p>Questions about the collection of your personal information can be directed to the Lead, PECSF, at 250-516-7894, <a href="mailto:PECSF@gov.bc.ca">PECSF@gov.bc.ca</a> or PO Box 9564 Stn Prov Govt, Victoria, BC V8W 9C5.
                </p>
