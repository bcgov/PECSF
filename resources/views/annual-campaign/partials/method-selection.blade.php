<div id="method-selection-area">
    ...
    <div class="card btn btn-outline-primary text-left {{ $pool_option == "C" ? 'active' : '' }}" id="card-pool1" tabindex="0">
    ...
    <div class="card btn btn-outline-primary text-left {{ $pool_option == "P" ? 'active' : '' }}" id="card-pool2" tabindex="0">
        <div class="card-body p-2">
            <div class="form-check">
...
$(function () {
    ...
    $('#method-selection-area .card').on('keyup', function(e) {
        var key  = e.key;
        if (key === ' ' || key === 'Enter') {
            e.preventDefault();
            $(this).trigger('click');
