    ...
    <td>
        <div class="form-row mx-3">
            ...
            <div class="form-group col-md-12">
                ...
                <input class="form-control specific_community_or_initiative" type="text" id="specific_community_or_initiative" name="additional[]" value="{{ ($charity != 'YYY') ? $charity->additional : '' }}" readonly />
