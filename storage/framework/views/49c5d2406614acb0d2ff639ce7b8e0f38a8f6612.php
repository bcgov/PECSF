...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 col-xl-12 offset-md-1">
            <h1 class="text-center">Welcome, <?php echo e(Auth::user()->name); ?></h1>
            <p class="text-center h4"><b>Choose from the options below:</b></p>

            <div class="row p-3">
                <div class="card_hook col-md-3 p-2">
                    <div class="card" style="height:220px" >
                        <a class="card-body text-center"  href="<?php echo e(route('volunteering.index')); ?>">
                ...
                <div class="card_hook col-md-5 p-2">
                    <div class="card" style="height:333px" >
                        <a href="<?php echo e(route('donations.list')); ?>" class="card-body text-center">
                ...
                <div class="card_hook col-md-3 p-2">
                    <div class="card" style="height:220px" >
                        <a href="<?php echo e(route('contact')); ?>" class="card-body text-center">
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo e(asset('img/home/01.jpeg')); ?>" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo e(asset('img/home/02.jpg')); ?>" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo e(asset('img/home/04.jpg')); ?>" alt="Third slide">
              </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered rounded" id="myTable2">
                            ...
                            <tr>
                                <td><?php echo e($index+1); ?><?php echo e($index == 0 ? 'st' : ($index == 1 ? 'nd' : ($index == 2 ? 'rd' : 'th'))); ?></td>
                                <td><?php echo e($charity['name']); ?></td>
                                <td><?php echo e(round(($charity['participation_rate'] * 100),2)); ?>%</td>
                                <td><?php echo e(round(($charity['previous_participation_rate'] * 100),2)); ?>%</td>

                                <td><?php echo e($charity['donors']); ?></td>
                                <td>$<?php echo e($charity['dollars']); ?></td>
                            </tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\x257354\Sites\PECSF\resources\views/home.blade.php ENDPATH**/ ?>