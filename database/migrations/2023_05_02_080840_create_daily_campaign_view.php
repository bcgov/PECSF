...
class CreateDailyCampaignView extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        CREATE VIEW daily_campaign_view AS
            ...
            -- Pledge (Gov)
                ...
                where as_of_date = (select max(as_of_date) from  eligible_employee_details e1 
                                     where e1.organization_code =  eligible_employee_details.organization_code 
                                       and e1.year = eligible_employee_details.year 
