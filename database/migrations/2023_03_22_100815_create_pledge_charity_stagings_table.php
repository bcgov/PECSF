...
class CreatePledgeCharityStagingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pledge_charity_stagings', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('prorate_amount')->nullable();


            $table->index(['history_id','pledge_type', 'calendar_year'], 'primary_keys_index');
    ...
    {
        Schema::dropIfExists('pledge_charity_stagings');
    }
}
